 ...
 *
 *	$Id: br_stp_if.c,v 1.1.1.1 2006/12/23 00:48:21 holmgren Exp $
 *
...
void br_stp_recalculate_bridge_id(struct net_bridge *br)
{
	...
	if (br->use_static_mac) {
		...
		if (memcmp(br->bridge_id.addr, br->static_mac, ETH_ALEN)) {
