 ...
 *
 *	$Id: br_mcast.c,v 1.1.1.1 2006/12/23 00:48:21 holmgren Exp $
 *
                                ...
                                void *pv)
{
    ...
    return ((jiffies - mrxm->ageing_timer) > br->ageing_time);
}

void br_mcast_age_list(struct net_bridge *br)
{
     __br_mcast_delete_if(br, __age_list_predicate, br);
}
...
{
    __br_mcast_delete_if(br, __destroy_list_predicate, 0);
}
...
{
    __br_mcast_delete_if(br, __delete_by_port_predicate, p);
}                             
                 ...
                 for (mrxp = me->rx_port_list; 
                     ...
                     for (mrxm = mrxp->rx_mac_list; 
                         ...
                         unsigned long jiffies_expire = 
                             mrxm->ageing_timer + br->ageing_time;
