 ...
 *
 *	$Id: br_stp_bpdu.c,v 1.1.1.1 2006/12/23 00:48:21 holmgren Exp $
 *
...
static void br_send_bpdu(struct net_bridge_port *p, unsigned char *data, int length)
{
	...
	skb->priority = br_priority_for_bpdu();
        ...
        /* Call back in the bridge code to encapsulate */
...
/* called under bridge lock */
void br_stp_handle_bpdu(struct net_bridge_port *p, struct sk_buff *skb)
{
	unsigned char *buf;
