 ...
 */
 ...
 char zftc_src[] ="$Source: /usr/local/cvs/viper/src/kernels/mips-linux-2.4.25/drivers/char/ftape/compressor/zftape-compress.c,v $";
 char zftc_rev[] = "$Revision: 1.1.1.1 $";
 char zftc_dat[] = "$Date: 2006/12/23 00:48:25 $";
