...
char zft_src[] __initdata = "$Source: /usr/local/cvs/viper/src/kernels/mips-linux-2.4.25/drivers/char/ftape/zftape/zftape-init.c,v $";
char zft_rev[] __initdata = "$Revision: 1.1.1.1 $";
char zft_dat[] __initdata = "$Date: 2006/12/23 00:48:25 $";
