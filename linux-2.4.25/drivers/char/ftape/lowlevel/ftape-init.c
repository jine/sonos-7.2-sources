...
/*      Global vars.
 */
char ft_src[] __initdata = "$Source: /usr/local/cvs/viper/src/kernels/mips-linux-2.4.25/drivers/char/ftape/lowlevel/ftape-init.c,v $";
char ft_rev[] __initdata = "$Revision: 1.1.1.1 $";
char ft_dat[] __initdata = "$Date: 2006/12/23 00:48:25 $";
