...
/*
 * $Log: eql.c,v $
 * Revision 1.1.1.1  2006/12/23 00:48:23  holmgren
 * inital viper source capture
 *
...
static char version[] __initdata = 
	"Equalizer1996: $Revision: 1.1.1.1 $ $Date: 2006/12/23 00:48:23 $ Simon Janes (simon@ncm.com)\n";
