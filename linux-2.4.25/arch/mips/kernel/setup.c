...
void *mips_config_base = -1;
EXPORT_SYMBOL(mips_config_base);
...
void __init setup_arch(char **cmdline_p)
{
	...
	case MACH_GROUP_AR531X:
		...
		break;
#endif
#if defined(CONFIG_IDT_79S334) || defined(CONFIG_IDT_79EB355) || defined(CONFIG_IDT_79RP355) || defined (CONFIG_IDT_79EB438) || defined(CONFIG_IDT_79EB365) || defined(CONFIG_IDT_79PMC438) || defined(CONFIG_IDT_79EB434)
        case MACH_GROUP_IDT:
                idt_setup();
                break;
#endif
