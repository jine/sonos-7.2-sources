...
#ifdef CONFIG_SONOS
    /*
      BUGBUG: Since there is a strange bug in the calculation of this value
      under certain conditions, I'll cut to the chase and use a constant which
      works only for the BR100. For a more rubust fix see fixcal.patch in this
      directory.
    */
    loops_per_jiffy = 0xe0000;
    (void)ticks;
    (void)loopbit;
    (void)lps_precision;
#else
