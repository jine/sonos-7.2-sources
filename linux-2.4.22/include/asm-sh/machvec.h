...
struct sh_machine_vector
{
	...
	unsigned int mv_hw_zoneplayer : 4;
	unsigned int mv_hw_handheld : 4;
};

extern struct sh_machine_vector sh_mv;

/* XXX BT the following is totally deprecated and really needs to go away.
 * I just need to track down any users
 */
#ifdef CONFIG_SONOS

#define	RINCON_MODEL_A3 	1
#define RINCON_MODEL_ES2 	2

#define MACH_ZONEPLAYER_A3		(sh_mv.mv_hw_zoneplayer == RINCON_MODEL_A3)
#define MACH_ZONEPLAYER_ES2		(sh_mv.mv_hw_zoneplayer == RINCON_MODEL_ES2)
#define MACH_HANDHELD_A3		(sh_mv.mv_hw_handheld == RINCON_MODEL_A3)
#define MACH_HANDHELD_ES2		(sh_mv.mv_hw_handheld == RINCON_MODEL_ES2)
