 ...
 */
#ifdef CONFIG_8272
/* XXX BT CPM_DATAONLY_BASE had been 0, but this really needs to be out of
 * the way of the PROFF_SMC1 and PROFF_SMC2 spaces which reserve 64 bytes
 * each.  Just for safety I'm setting this to 256 bytes into the dpram
 */
#define CPM_DATAONLY_BASE	((uint)0x100)
#define CPM_DATAONLY_SIZE	((uint)0x2000 - CPM_DATAONLY_BASE)
#define CPM_DP_NOSPACE		((uint)0x7fffffff)
#define CPM_FCC_SPECIAL_BASE	((uint)0x00009000)
#else
#define CPM_DATAONLY_BASE	((uint)0xB800)
#define CPM_DATAONLY_SIZE	((uint)0xC000 - CPM_DATAONLY_BASE)
#define CPM_DP_NOSPACE		((uint)0x7fffffff)
...
#define BD_SC_NAK	((ushort)0x0004)	/* Transmit not acked (I2c)*/
#define BD_SC_OV	((ushort)0x0002)	/* Overrun (RX) */
#define BD_SC_UN	((ushort)0x0002)	/* Underrun (TX) */
#define BD_SC_CD	((ushort)0x0001)	/* CD# lost (RX) */
#define BD_SC_CT	((ushort)0x0001)	/* CTS# lost (TX) */
#define BD_SC_CL	((ushort)0x0001)	/* multimaster collision(I2C)*/
...
/* SCCE / SCCM for Transparent mode
 */
#define SCCE_TRANS_DCC	((ushort)0x0400)
#define SCCE_TRANS_GRA	((ushort)0x0080)
#define SCCE_TRANS_TXE	((ushort)0x0010)
#define SCCE_TRANS_BSY	((ushort)0x0004)
#define SCCE_TRANS_TXB	((ushort)0x0002)
#define SCCE_TRANS_RXB	((ushort)0x0001)
...
#define FCCE_GFEMR_TIREM	((u_char)0x80)
#define FCCE_GFEMR_LPB		((u_char)0x40)
#define FCCE_GFEMR_CLK		((u_char)0x20)
...
#define FCC_PSMR_RMII	((uint)0x00020000)	/* RMII mode */
...
#define I2C_I2COM_STR ((u_char)0x80)
#define I2C_I2COM_M ((u_char)0x01)
...
#define IDMA_BD_VALID	((uint)0x80000000)	/* Valid */
#define IDMA_BD_WRAP	((uint)0x20000000)	/* Final BD in table */
#define IDMA_BD_INTRPT	((uint)0x10000000)	/* Interrupt after serviced */
#define IDMA_BD_LAST	((uint)0x08000000)      /* Last buffer of a chain */
...
#define IDMA_BD_DBO_LE	((uint)0x00040000)   /* Destination byte ordering, LE */
#define IDMA_BD_DBO_BE	((uint)0x00080000)   /* Destination byte ordering, BE */
#define IDMA_BD_DDTB	((uint)0x00010000)	/* Destination data bus */
#define IDMA_BD_SGBL	((uint)0x00002000)	/* Source global */
#define IDMA_BD_SBO_LE	((uint)0x00000800)	/* Source byte ordering, LE */
#define IDMA_BD_SBO_BE	((uint)0x00001000)	/* Source byte ordering, BE */
