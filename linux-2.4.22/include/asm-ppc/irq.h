...
#ifndef CONFIG_8272 // XXX BT this is for the 8260, 8272 slightly different
...
#else /*CONFIG_8272*/
#define SIU_INT_PC29            ((uint)0x30)
#define SIU_INT_PC23            ((uint)0x31)
#define SIU_INT_PC15            ((uint)0x32)
#define SIU_INT_PC14            ((uint)0x33)
#define SIU_INT_PC13            ((uint)0x34)
#define SIU_INT_PC12            ((uint)0x35)
#define SIU_INT_PC11            ((uint)0x36)
#define SIU_INT_PC10            ((uint)0x37)
#define SIU_INT_PC9             ((uint)0x38)
#define SIU_INT_PC8             ((uint)0x39)
#define SIU_INT_PC7             ((uint)0x3a)
#define SIU_INT_PC6             ((uint)0x3b)
#define SIU_INT_PC5             ((uint)0x3c)
#define SIU_INT_PC4             ((uint)0x3d)
#define SIU_INT_PC1             ((uint)0x3e)
#define SIU_INT_PC0             ((uint)0x3f)
#endif

#if defined CONFIG_MPC8272ADS || defined CONFIG_ADS8266
#ifdef CONFIG_PCI /*PCI interrupt controller*/
#define INT_PCI_TO_SIU		SIU_INT_IRQ2
#endif
/* SEC engine interrupt */
#define SIU_INT_SEC		((uint)0x2f)
#endif

#ifdef CONFIG_PCI
#if defined CONFIG_MPC8272ADS || defined CONFIG_ADS8266
#define NR_PCI_INTS	4
#define PCI_INT_SLOT0		((uint)0x64)
#define PCI_INT_SLOT1		((uint)0x65)
#define PCI_INT_SLOT2		((uint)0x66)
#else
#define NR_PCI_INTS	4
#define PCI_INT_SLOT0		((uint)0x64)
#define PCI_INT_SLOT1		((uint)0x65)
#define PCI_INT_SLOT2		((uint)0x66)
#define PCI_INT_SLOT3		((uint)0x67)
#endif
#endif
