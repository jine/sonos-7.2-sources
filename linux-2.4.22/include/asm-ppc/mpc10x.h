...
#if defined CONFIG_8272 || defined CONFIG_ADS8266
/* 0x18c0 is both the ADS8266 and the MPC8272 PCI Device ID */
#define	MPC10X_BRIDGE_8266	((0x18c0 << 16) | PCI_VENDOR_ID_MOTOROLA)
#define	MPC10X_BRIDGE_8272	((0x18c1 << 16) | PCI_VENDOR_ID_MOTOROLA)
#endif
...
#if defined CONFIG_8272 || defined CONFIG_ADS8266
/* MPC826x Map (MPC826x Map) Defines */
#define MPC10X_MAP826x_CNFG_ADDR	(0xf0000000 + 0x10900)
#define MPC10X_MAP826x_CNFG_DATA	(0xf0000000 + 0x10904)
#define MPC10X_MAP826x_ISA_IO_BASE	0xe0000000
#define MPC10X_MAP826x_ISA_MEM_BASE	0x80000000
#define	MPC10X_MAP826x_DRAM_OFFSET	0x00000000
#endif
