...
/* XXX BT gcc 3.4 (with the right options, anyways) issues a warning about
 * const being ignored as a qualifier for a return type.  I kind of
 * understand why the author included it, but I agree with gcc.  const on
 * a return type really doesn't make sense.
 */
