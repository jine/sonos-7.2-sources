...
#ifdef CONFIG_SONOS
	/* XXX BT 300MHz MPC8247 is only 200 bogomips, the default for this below
	 * therefore makes early udelay() 5x slow, which is obnoxious.  May
	 * want to revisit this if we switch to 400MHz...
	 */
