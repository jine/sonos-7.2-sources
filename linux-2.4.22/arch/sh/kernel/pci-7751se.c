...
#ifdef CONFIG_SONOS
   PCIC_WRITE(SH7751_PCILSR0, 0x01f00000);   /* MEM (full 64M exposed)       */
#else
...
int __init pcibios_map_platform_irq(u8 slot, u8 pin)
{
        switch (slot) {
#ifdef CONFIG_SONOS
        case 0: return 8;       /* mini pci - zp  IRL2 -> IRQ8 */
        case 1: return 2;       /* AMD or RTL8139C+ ethernet - zp IRL0 -> IRQ2 */
        case 13: return 8;      /* HH minipci - IRL2 */
#else
        case 0: return 13;
        case 1: return 9; 	/* AMD Ethernet controller */
        case 2: return -1;
        case 3: return -1;
        case 4: return -1;
#endif
