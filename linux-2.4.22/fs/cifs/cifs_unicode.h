...
enum { CIFS_TO_REMOTE, CIFS_TO_LOCAL };

int cifs_convert(char *to, const char *from, int tolimit, 
                 const struct nls_table *local_codepage, int dir);
int cifs_convertn(char *to, const char *from, int tolimit, int fromlimit,
                  const struct nls_table *local_codepage, int dir);
int cifs_strnlen(const char *s, int lim, const struct nls_table *local);
