...
//  All rights reserved.
//
//  Panel: 320x240x2bpp 67Hz Color 8-Bit STN, Format 2 (PCLK=6.000MHz)
//
...
//               mode.
//
//  This file has been tested with EPSON S5U13704/5B00C REV2.0 Board
//  with S1D13705 and KYOCERA KCS057QV1AA-A47 320x240 Single 8 bit 
//  Color STN 5V Format 2 panel.
//
//  Dip switches: Open:1,2,3  Closed: 4,5,6
//  Jumpers: JP1:1-2, JP2:1-2, JP3:1-2, JP4:2-3, JP5: Out, JP7:1-2
//  U2: 6.0000MHz
//  U7: 50.000MHz
//  U15: BEM7.0
//==================================================================
...
#define S1D_DISPLAY_BPP                 2
#define S1D_DISPLAY_SCANLINE_BYTES      80
...
static S1D_REGS aS1DRegs[] =
{
    ...
    { 0x02,             0x60 },       // Mode Register 1 Register
    ...
    { 0x1C,             0x50 },       // Line Byte Count Register
    { 0x1D,             0x00 },       // Not Used
    { 0x1E,             0x00 },       // Not Used
    { 0x1F,             0x00 },       // Not Used
};
