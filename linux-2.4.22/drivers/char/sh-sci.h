/* $Id: sh-sci.h,v 1.6.26.1 2006/01/06 21:21:51 tober Exp $
 *
...
/*Rincon devices use the 7751R which has SCI and SCIF but a different driver
 *uses the SCIF, so, for safety, this driver only knows about the SCI
 */
#define SCI_NPORTS 1
#define SCI_INIT { \
