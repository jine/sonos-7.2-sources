 ...
 * Revision history:
 * $Log: sx.c,v $
 * Revision 1.2.26.1  2005/12/24 16:57:22  tober
 * kernel 2.4.20->2.4.22
 *
 * Revision 1.2  2003/06/26 21:08:34  vangool
 * *** empty log message ***
 *
...
#define RCS_ID "$Id: sx.c,v 1.2.26.1 2005/12/24 16:57:22 tober Exp $"
#define RCS_REV "$Revision: 1.2.26.1 $"
