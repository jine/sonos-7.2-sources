/*
 *  $Id: ipconfig.c,v 1.3.26.2 2005/12/29 17:15:57 tober Exp $
 *
...
/*XXX BT the following must be somebody's private hack*/
#if 0
	if ((ic_myaddr & 0xffffff) == 0x01000a) {
		root_server_addr = 0xed01000a;
	} else {
		root_server_addr = 0x0c02000a;
	}
#endif
