 ...
 *
 *	$Id: br_private.h,v 1.8 2004/08/10 03:46:10 millington Exp $
 *
...
struct net_bridge
{
	...
	unsigned			sonos_diag_bridge_forward:1;
#endif
...
extern void br_get_port_ifindices(struct net_bridge *br,
			   int *ifindices);
extern unsigned char br_get_routing_capabilities(struct net_bridge *br);
