...
#define NO_CHOOSE_IPOD_CONFIGURATION
...
#ifdef NO_CHOOSE_IPOD_CONFIGURATION
	if ((le16_to_cpu(udev->descriptor.idVendor)==0x05AC)&&((le16_to_cpu(udev->descriptor.idProduct)&0xff00)==0x1200)) goto no_choose_config;
#endif
