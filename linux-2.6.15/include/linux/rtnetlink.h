...
/*
 * Oh, the horror.  This is now a bitmask in userspace and a bit number in
 * the kernel.  We use the same define on both sides, and we share the driver
 * with the 2.4 kernel, so this is actually the cleanest fix.  Really...
 */
#ifdef __KERNEL__
