...
/* Sonos: bootgeneration and bootsection from bootloader */
static int bootgeneration = 0;
...
#endif
	/* Sonos: bootsection and bootgeneration from bootloader */
        {
		.ctl_name	= KERN_BOOTSECTION,
