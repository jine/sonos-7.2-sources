...
#define wget_trivial_usage \
	USE_FEATURE_WGET_LONG_OPTIONS( \
       ...
       "	[-U|--user-agent agent] [-T|--timeout secs] [-C|--content-len clen_file] url" \
	) \
	SKIP_FEATURE_WGET_LONG_OPTIONS( \
       "[-csq] [-O file] [-Y on/off] [-P DIR] [-U agent] [-T secs] [-C clen_file] url" \
	)
#define wget_full_usage "\n\n" \
     ...
     "\n	-q	Quiet" \
     "\n	-C	Write content-length to filename" \
     "\n	-P	Set directory prefix to DIR" \
     "\n	-O	Save to filename ('-' for stdout)" \
     "\n	-T	Set read timeout in seconds" \
