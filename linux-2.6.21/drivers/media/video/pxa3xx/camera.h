...
#define	CAMERA_TYPE_OMNIVISION_5623	8
#define	CAMERA_TYPE_OMNIVISION_7673	9
#define CAMERA_TYPE_MAX			CAMERA_TYPE_OMNIVISION_7673
...
struct camera_frame_buffer_info_s {
	 ...
	 */
	volatile u32		ch1_dma_desc_phy_addr	\
			[SPECIAL_DMA_DESC_NUM_PER_CHANNEL_PER_FRAME];

	/* pointer to an array of virtual address of
	 * channel 1's DMA chain for this buffer;
	 */
	CI_DMAC_DESCRIPTOR_T	*ch1_dma_desc_vir_addr	\
			[SPECIAL_DMA_DESC_NUM_PER_CHANNEL_PER_FRAME];
	 ...
	 */
	volatile u32		ch2_dma_desc_phy_addr	\
			[SPECIAL_DMA_DESC_NUM_PER_CHANNEL_PER_FRAME];

	/* pointer to an array of virtual address of
	 * channel 2's DMA chain for this buffer;
	 */
	CI_DMAC_DESCRIPTOR_T	*ch2_dma_desc_vir_addr	\
			[SPECIAL_DMA_DESC_NUM_PER_CHANNEL_PER_FRAME];
 ...
 * I2C API
 *****************************************************************************/
/* Write "bytesCount" data from "bytesBuf" to slave device "slaveAddr"
 * Return: 0-success, non-0: error
 */
int OS_I2CMasterWriteData(u8 slaveAddr, const u8 * bytesBuf, int bytesCount);

/* Read "bufLen" data to "bytesBuf" to slave device "slaveAddr"
 * Return: 0-success, non-0: error
 */
int OS_I2CMasterReadData(u8 slaveAddr, u8 * bytesBuf, int bufLen);
