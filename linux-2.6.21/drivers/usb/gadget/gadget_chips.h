...
#ifdef CONFIG_USB_GADGET_PXA3xx_UDC
#define	gadget_is_pxa3xx_udc(g)	!strcmp("pxa3xx_udc", (g)->name)
#else
#define	gadget_is_pxa3xx_udc(g)	0
#endif
...
static inline int usb_gadget_controller_number(struct usb_gadget *gadget)
{
	if (gadget_is_net2280(gadget))
		...
		return 0x18;
	else if (gadget_is_pxa3xx_udc(gadget))
		return 0x19;
