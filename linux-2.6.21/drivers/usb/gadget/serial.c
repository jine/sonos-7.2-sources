...
/* for serial driver be recognized by PROTOCOL, since CLASS/SUBCLASS 
	are all the same with other	CDC data interfaces within CDC 
	gadget drivers, e.g. CDC Ethernet 
*/
...
#else
	.bInterfaceProtocol =	GS_PROTOCOL_VENDOR_SPEC,
#endif
...
static int __init gs_bind(struct usb_gadget *gadget)
{
	...
	if (use_acm) {
		...
		gs_device_desc.idProduct = __constant_cpu_to_le16(
						GS_CDC_PRODUCT_ID),
#ifdef CONFIG_MULTIPLE_GADGET_DRIVERS
		gs_device_desc.bDeviceSubClass = USB_CDC_SUBCLASS_ACM;
#endif
