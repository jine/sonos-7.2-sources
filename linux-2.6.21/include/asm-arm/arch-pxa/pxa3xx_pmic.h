...
#define PMIC_EVENT_CH_CCTO	(1 << 9)
#define PMIC_EVENT_CH_TCTO	(1 << 10)
...
struct pmic_ops {
	...
	int (*set_apps_and_sram)(int apps_mv, int sram_mv);
...
extern int pxa3xx_pmic_set_apps_and_sram(int apps_mv,int sram_mv);
