/*
 * include/asm-arm/arch-pxa/micco.h
 *
...
#define	MICCO_STATUS_A_TBAT	(1 << 4)
#define	MICCO_STATUS_A_VBATMON	(1 << 5)
...
#define MICCO_CCTR_CONTROL	0x43
#define MICCO_TCTR_CONTROL	0x44
#define MICCO_CHARGE_PULSE	0x45
...
/* For Audio */
int inline micco_codec_read(u8 reg, u8 *val);
int inline micco_codec_write(u8 reg, u8 val);
