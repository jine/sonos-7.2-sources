...
#ifndef __ASM_MACH_ZYLONITE_H__
#define __ASM_MACH_ZYLONITE_H__
...
#define MFP_DREQ_GPIO				(MFP_PIN_GPIO0)
#define MFP_DREQ_GPIO_AF			(MFP_PIN_GPIO0_AF_DRQ)

#define MFP_MMC_CD_0_GPIO			(MFP_PIN_GPIO1)
#define MFP_MMC_CD_0_GPIO_AF			(MFP_PIN_GPIO1_AF_GPIO_1)

#define MFP_RDY					(MFP_PIN_GPIO2)
#define MFP_RDY_AF				(MFP_PIN_GPIO2_AF_RDY)

#define MFP_FLASH_NOR_CS_N_GPIO			(MFP_PIN_GPIO3)
#define MFP_FLASH_NOR_CS_N_GPIO_AF		(MFP_PIN_GPIO3_AF_nCS_2)

#define MFP_DEBUG_ETH_CS_N_GPIO			(MFP_PIN_GPIO4)
#define MFP_DEBUG_ETH_CS_N_GPIO_AF		(MFP_PIN_GPIO4_AF_nCS_3)

#define MFP_MMC_CD_1_GPIO			(MFP_PIN_GPIO4)
#define MFP_MMC_CD_1_GPIO_AF			(MFP_PIN_GPIO4_AF_GPIO_4)

#define MFP_MMC_WP_0_N_GPIO			(MFP_PIN_GPIO5)
#define MFP_MMC_WP_0_N_GPIO_AF			(MFP_PIN_GPIO5_AF_GPIO_5)
#define MFP_NPIOR_GPIO				(MFP_PIN_GPIO5) 
#define MFP_NPIOR_GPIO_AF			(MFP_PIN_GPIO5_AF_NPIOR)

#define MFP_MMC_WP_1_N_GPIO			(MFP_PIN_GPIO6)
#define MFP_MMC_WP_1_N_GPIO_AF			(MFP_PIN_GPIO6_AF_GPIO_6)
#define MFP_NPIOW_GPIO				(MFP_PIN_GPIO6)
#define MFP_NPIOW_GPIO_AF			(MFP_PIN_GPIO6_AF_nPIOW)

//#define MFP_PHONE_CLOSED_GPIO			(MFP_PIN_GPIO7)
//#define MFP_PHONE_CLOSED_GPIO_AF		(MFP_PIN_GPIO7_AF_GPIO_7)
#define MFP_NIOIS16_GPIO			(MFP_PIN_GPIO7)
#define MFP_NIOIS16_GPIO_AF			(MFP_PIN_GPIO7_AF_nIOIS16)

//#define MFP_PHONE_FLIPPED_GPIO		(MFP_PIN_GPIO8)
//#define MFP_PHONE_FLIPPED_GPIO_AF		(MFP_PIN_GPIO8_AF_GPIO_8) 
#define MFP_NPWAIT_GPIO				(MFP_PIN_GPIO8)
#define MFP_NPWAIT_GPIO_AF			(MFP_PIN_GPIO8_AF_nPWAIT)

#define MFP_DEBUG_ETH_INT_GPIO			(MFP_PIN_GPIO9)
#define MFP_DEBUG_ETH_INT_GPIO_AF		(MFP_PIN_GPIO9_AF_GPIO_9)

#define MFP_U2D_UTM_CLK				(MFP_PIN_GPIO10)
#define MFP_U2D_UTM_CLK_AF			(MFP_PIN_GPIO10_AF_UTM_CLK)

// This PWM is an input to the Hermon daughter card, as is PWM1.  
// Its intended usage is not specified.
#define MFP_RSVD_PWM_0				(MFP_PIN_GPIO11)
#define MFP_RSVD_PWM_0_AF			(MFP_PIN_GPIO11_AF_PWM_0)

#define MFP_RSVD_AC97_SDATA_IN_0		(MFP_PIN_GPIO11)
#define MFP_RSVD_AC97_SDATA_IN_0_AF		(MFP_PIN_GPIO11_AF_AC97_SDATA_IN_2)

#define MFP_AC97_SDATA_IN_2			(MFP_PIN_GPIO11)
#define MFP_AC97_SDATA_IN_2_AF			(MFP_PIN_GPIO11_AF_AC97_SDATA_IN_2)

// This PWM is an input to the Hermon daughter card, as is PWM0.
// Its intended usage is not specified.
#define MFP_RSVD_PWM_1				(MFP_PIN_GPIO12)
#define MFP_RSVD_PWM_1_AF			(MFP_PIN_GPIO12_AF_PWM_1)

#define MFP_CIR_ON_PWM				(MFP_PIN_GPIO13)
#define MFP_CIR_ON_PWM_AF			(MFP_PIN_GPIO13_AF_PWM_2)

#define MFP_BACKLIGHT_PWM			(MFP_PIN_GPIO14)
#define MFP_BACKLIGHT_PWM_AF			(MFP_PIN_GPIO14_AF_PWM_3)

#define MFP_AC97_INT_N_GPIO			(MFP_PIN_GPIO15)
#define MFP_AC97_INT_N_GPIO_AF			(MFP_PIN_GPIO15_AF_GPIO_15)

#define MFP_CAMERA_STROBE_EN_GPIO		(MFP_PIN_GPIO16)
#define MFP_CAMERA_STROBE_EN_GPIO_AF		(MFP_PIN_GPIO16_AF_GPIO_16)

#define MFP_CAMERA_LIGHT_EN_GPIO		(MFP_PIN_GPIO17)
#define MFP_CAMERA_LIGHT_EN_GPIO_AF		(MFP_PIN_GPIO17_AF_GPIO_17)

#define MFP_MMC_DAT0				(MFP_PIN_GPIO18)
#define MFP_MMC_DAT0_AF				(MFP_PIN_GPIO18_AF_MM1_DAT0)

#define MFP_MMC_DAT1				(MFP_PIN_GPIO19)
#define MFP_MMC_DAT1_AF				(MFP_PIN_GPIO19_AF_MM1_DAT1)

#define MFP_MMC_DAT2				(MFP_PIN_GPIO20)
#define MFP_MMC_DAT2_AF				(MFP_PIN_GPIO20_AF_MM1_DAT2_CS0)

#define MFP_MMC_DAT3				(MFP_PIN_GPIO21)
#define MFP_MMC_DAT3_AF				(MFP_PIN_GPIO21_AF_MM1_DAT3_CS1)

#define MFP_MMC_CLK				(MFP_PIN_GPIO22)
#define MFP_MMC_CLK_AF				(MFP_PIN_GPIO22_AF_MM1_CLK)

#define MFP_MMC_CMD_0				(MFP_PIN_GPIO23)
#define MFP_MMC_CMD_0_AF			(MFP_PIN_GPIO23_AF_MM1_CMD)

#define MFP_MMC2_DAT0				(MFP_PIN_GPIO24)
#define MFP_MMC2_DAT0_AF			(MFP_PIN_GPIO24_AF_MM2_DAT0)

#define MFP_MMC2_DAT1				(MFP_PIN_GPIO25)
#define MFP_MMC2_DAT1_AF			(MFP_PIN_GPIO25_AF_MM2_DAT1)

#define MFP_MMC2_DAT2_CS0			(MFP_PIN_GPIO26)
#define MFP_MMC2_DAT2_CS0_AF			(MFP_PIN_GPIO26_AF_MM2_DAT2_CS0)

#define MFP_MMC2_DAT3_CS1			(MFP_PIN_GPIO27)
#define MFP_MMC2_DAT3_CS1_AF			(MFP_PIN_GPIO27_AF_MM2_DAT3_CS1)

#define MFP_MMC2_CLK				(MFP_PIN_GPIO28)
#define MFP_MMC2_CLK_AF				(MFP_PIN_GPIO28_AF_MM2_CLK)

#define MFP_MMC2_CMD				(MFP_PIN_GPIO29)
#define MFP_MMC2_CMD_AF				(MFP_PIN_GPIO29_AF_MM2_CMD)

#define MFP_CFCD_GPIO				(MFP_PIN_GPIO30)
#define MFP_CFCD_GPIO_AF			(MFP_PIN_GPIO30_AF_GPIO_30)

#define MFP_MMC_CMD_1				(MFP_PIN_GPIO31)
#define MFP_MMC_CMD_1_AF			(MFP_PIN_GPIO31_AF_MM1_CMD)

#define MFP_SCL					(MFP_PIN_GPIO32)
#define MFP_SCL_AF				(MFP_PIN_GPIO32_AF_SCL)

#define MFP_SDA					(MFP_PIN_GPIO33)
#define MFP_SDA_AF				(MFP_PIN_GPIO33_AF_SDA)

#define MFP_AC97_SYSCLK				(MFP_PIN_GPIO34)
#define MFP_AC97_SYSCLK_AF			(MFP_PIN_GPIO34_AF_AC97_SYSCLK)

#define MFP_AC97_SDATA_IN_0			(MFP_PIN_GPIO35)
#define MFP_AC97_SDATA_IN_0_AF			(MFP_PIN_GPIO35_AF_AC97_SDATA_IN_0)

#define MFP_AC97_SDATA_IN_1			(MFP_PIN_GPIO36)
#define MFP_AC97_SDATA_IN_1_AF			(MFP_PIN_GPIO36_AF_AC97_SDATA_IN_1)

#define MFP_AC97_SDATA_OUT			(MFP_PIN_GPIO37)
#define MFP_AC97_SDATA_OUT_AF			(MFP_PIN_GPIO37_AF_AC97_SDATA_OUT)

#define MFP_AC97_SYNC				(MFP_PIN_GPIO38)
#define MFP_AC97_SYNC_AF			(MFP_PIN_GPIO38_AF_AC97_SYNC)

#define MFP_AC97_AC97_BITCLK			(MFP_PIN_GPIO39)
#define MFP_AC97_AC97_BITCLK_AF			(MFP_PIN_GPIO39_AF_AC97_BITCLK)

#define MFP_AC97_nACRESET			(MFP_PIN_GPIO40)
#define MFP_AC97_nACRESET_AF			(MFP_PIN_GPIO40_AF_AC97_nACRESET)

#define MFP_SSP_2_CLK				(MFP_PIN_GPIO35)
#define MFP_SSP_2_CLK_AF			(MFP_PIN_GPIO35_AF_SSPSCLK2)

#define MFP_SSP_2_FRM				(MFP_PIN_GPIO36)
#define MFP_SSP_2_FRM_AF			(MFP_PIN_GPIO36_AF_SSPSFRM2)

#define MFP_SSP_2_TXD				(MFP_PIN_GPIO37)
#define MFP_SSP_2_TXD_AF			(MFP_PIN_GPIO37_AF_SSPTXD2)

#define MFP_SSP_2_RXD				(MFP_PIN_GPIO38)
#define MFP_SSP_2_RXD_AF			(MFP_PIN_GPIO38_AF_SSPRXD2)

#define MFP_FFRXD				(MFP_PIN_GPIO41)
#define MFP_FFRXD_AF				(MFP_PIN_GPIO41_AF_UART1_RXD)

#define MFP_FFTXD				(MFP_PIN_GPIO42)
#define MFP_FFTXD_AF				(MFP_PIN_GPIO42_AF_UART1_TXD)

#define MFP_FFCTS				(MFP_PIN_GPIO43)
#define MFP_FFCTS_AF				(MFP_PIN_GPIO43_AF_UART1_CTS)

#define MFP_FFDCD				(MFP_PIN_GPIO44)
#define MFP_FFDCD_AF				(MFP_PIN_GPIO44_AF_UART1_DCD)

#define MFP_FFDSR				(MFP_PIN_GPIO45)
#define MFP_FFDSR_AF				(MFP_PIN_GPIO45_AF_UART1_DSR)

#define MFP_FFRI				(MFP_PIN_GPIO46)
#define MFP_FFRI_AF				(MFP_PIN_GPIO46_AF_UART1_RI)

#define MFP_USB2_DETECT				(MFP_PIN_GPIO46)
#define MFP_USB2_DETECT_AF			(MFP_PIN_GPIO46_AF_GPIO_46)

#define MFP_FFDTR				(MFP_PIN_GPIO47)
#define MFP_FFDTR_AF				(MFP_PIN_GPIO47_AF_UART1_DTR)

#define MFP_FFRTS				(MFP_PIN_GPIO48)
#define MFP_FFRTS_AF				(MFP_PIN_GPIO48_AF_UART1_RTS)

#define MFP_CIF_DD_0				(MFP_PIN_GPIO49)
#define MFP_CIF_DD_0_AF				(MFP_PIN_GPIO49_AF_CIF_DD_0)

#define MFP_U2D_DATA0				(MFP_PIN_GPIO49)
#define MFP_U2D_DATA0_AF			(MFP_PIN_GPIO49_AF_U2D_DATA0)

#define MFP_CIF_DD_1				(MFP_PIN_GPIO50)
#define MFP_CIF_DD_1_AF				(MFP_PIN_GPIO50_AF_CIF_DD_1)

#define MFP_U2D_DATA1				(MFP_PIN_GPIO50)
#define MFP_U2D_DATA1_AF			(MFP_PIN_GPIO50_AF_U2D_DATA1)

#define MFP_CIF_DD_2				(MFP_PIN_GPIO51)
#define MFP_CIF_DD_2_AF				(MFP_PIN_GPIO51_AF_CIF_DD_2)

#define MFP_U2D_DATA2				(MFP_PIN_GPIO51)
#define MFP_U2D_DATA2_AF			(MFP_PIN_GPIO51_AF_U2D_DATA2)

#define MFP_CIF_DD_3				(MFP_PIN_GPIO52)
#define MFP_CIF_DD_3_AF				(MFP_PIN_GPIO52_AF_CIF_DD_3)

#define MFP_U2D_DATA3				(MFP_PIN_GPIO52)
#define MFP_U2D_DATA3_AF			(MFP_PIN_GPIO52_AF_U2D_DATA3)

#define MFP_CIF_DD_4				(MFP_PIN_GPIO53)
#define MFP_CIF_DD_4_AF				(MFP_PIN_GPIO53_AF_CIF_DD_4)

#define MFP_U2D_DATA4				(MFP_PIN_GPIO53)
#define MFP_U2D_DATA4_AF			(MFP_PIN_GPIO53_AF_U2D_DATA4)

#define MFP_CIF_DD_5				(MFP_PIN_GPIO54)
#define MFP_CIF_DD_5_AF				(MFP_PIN_GPIO54_AF_CIF_DD_5)

#define MFP_U2D_DATA5				(MFP_PIN_GPIO54)
#define MFP_U2D_DATA5_AF			(MFP_PIN_GPIO54_AF_U2D_DATA5)

#define MFP_CIF_DD_6				(MFP_PIN_GPIO55)
#define MFP_CIF_DD_6_AF				(MFP_PIN_GPIO55_AF_CIF_DD_6)

#define MFP_U2D_DATA6				(MFP_PIN_GPIO55)
#define MFP_U2D_DATA6_AF			(MFP_PIN_GPIO55_AF_U2D_DATA6)

#define MFP_CIF_DD_7				(MFP_PIN_GPIO56)
#define MFP_CIF_DD_7_AF				(MFP_PIN_GPIO56_AF_CIF_DD_7)

#define MFP_U2D_DATA7				(MFP_PIN_GPIO56)
#define MFP_U2D_DATA7_AF			(MFP_PIN_GPIO56_AF_U2D_DATA7)

#define MFP_CIF_DD_8				(MFP_PIN_GPIO57)
#define MFP_CIF_DD_8_AF				(MFP_PIN_GPIO57_AF_CIF_DD_8)

#define MFP_CIF_DD_9				(MFP_PIN_GPIO58)
#define MFP_CIF_DD_9_AF				(MFP_PIN_GPIO58_AF_CIF_DD_9)

#define MFP_U2D_RXVALID				(MFP_PIN_GPIO58)
#define MFP_U2D_RXVALID_AF			(MFP_PIN_GPIO58_AF_UTM_RXVALID)

#define MFP_CIF_MCLK				(MFP_PIN_GPIO59)
#define MFP_CIF_MCLK_AF				(MFP_PIN_GPIO59_AF_CIF_MCLK)

#define MFP_U2D_RXACTIVE			(MFP_PIN_GPIO59)
#define MFP_U2D_RXACTIVE_AF			(MFP_PIN_GPIO59_AF_UTM_RXACTIVE)

#define MFP_CIF_PCLK				(MFP_PIN_GPIO60)
#define MFP_CIF_PCLK_AF				(MFP_PIN_GPIO60_AF_CIF_PCLK)

#define MFP_U2D_RXERROR				(MFP_PIN_GPIO60)
#define MFP_U2D_RXERROR_AF			(MFP_PIN_GPIO60_AF_U2D_RXERROR)

#define MFP_CIF_HSYNC				(MFP_PIN_GPIO61)
#define MFP_CIF_HSYNC_AF			(MFP_PIN_GPIO61_AF_CIF_HSYNC)

#define MFP_U2D_OPMODE0				(MFP_PIN_GPIO61)
#define MFP_U2D_OPMODE0_AF			(MFP_PIN_GPIO61_AF_U2D_OPMODE0)

#define MFP_CIF_VSYNC				(MFP_PIN_GPIO62)
#define MFP_CIF_VSYNC_AF			(MFP_PIN_GPIO62_AF_CIF_VSYNC)

#define MFP_U2D_OPMODE1				(MFP_PIN_GPIO62)
#define MFP_U2D_OPMODE1_AF			(MFP_PIN_GPIO62_AF_U2D_OPMODE1)

#define MFP_L_DD_8				(MFP_PIN_GPIO63)
#define MFP_L_DD_8_AF				(MFP_PIN_GPIO63_AF_L_DD_8)

#define MFP_L_LP_DD_8				(MFP_PIN_GPIO63)
#define MFP_L_LP_DD_8_AF			(MFP_PIN_GPIO63_AF_L_LP_DD_8)

#define MFP_L_DD_9				(MFP_PIN_GPIO64)
#define MFP_L_DD_9_AF				(MFP_PIN_GPIO64_AF_L_DD_9)

#define MFP_L_LP_DD_9				(MFP_PIN_GPIO64)
#define MFP_L_LP_DD_9_AF			(MFP_PIN_GPIO64_AF_L_LP_DD_9)

#define MFP_L_DD_10				(MFP_PIN_GPIO65)
#define MFP_L_DD_10_AF				(MFP_PIN_GPIO65_AF_L_DD_10)

#define MFP_L_LP_DD_10				(MFP_PIN_GPIO65)
#define MFP_L_LP_DD_10_AF			(MFP_PIN_GPIO65_AF_L_LP_DD_10)

#define MFP_L_DD_11				(MFP_PIN_GPIO66)
#define MFP_L_DD_11_AF				(MFP_PIN_GPIO66_AF_L_LP_DD_11)

#define MFP_L_LP_DD_11				(MFP_PIN_GPIO66)
#define MFP_L_LP_DD_11_AF			(MFP_PIN_GPIO66_AF_L_LP_DD_11)

#define MFP_L_DD_12				(MFP_PIN_GPIO67)
#define MFP_L_DD_12_AF				(MFP_PIN_GPIO67_AF_L_DD_12)

#define MFP_L_LP_DD_12				(MFP_PIN_GPIO67)
#define MFP_L_LP_DD_12_AF			(MFP_PIN_GPIO67_AF_L_LP_DD_12)

#define MFP_L_DD_13				(MFP_PIN_GPIO68)
#define MFP_L_DD_13_AF				(MFP_PIN_GPIO68_AF_L_DD_13)

#define MFP_L_LP_DD_13				(MFP_PIN_GPIO68)
#define MFP_L_LP_DD_13_AF			(MFP_PIN_GPIO68_AF_L_LP_DD_13)

#define MFP_L_DD_14				(MFP_PIN_GPIO69)
#define MFP_L_DD_14_AF				(MFP_PIN_GPIO69_AF_L_DD_14)

#define MFP_L_LP_DD_14				(MFP_PIN_GPIO69)
#define MFP_L_LP_DD_14_AF			(MFP_PIN_GPIO69_AF_L_LP_DD_14)

#define MFP_L_DD_15				(MFP_PIN_GPIO70)
#define MFP_L_DD_15_AF				(MFP_PIN_GPIO70_AF_L_DD_15)

#define MFP_L_LP_DD_15				(MFP_PIN_GPIO70)
#define MFP_L_LP_DD_15_AF			(MFP_PIN_GPIO70_AF_L_LP_DD_15)

#define MFP_L_DD_16				(MFP_PIN_GPIO71)
#define MFP_L_DD_16_AF				(MFP_PIN_GPIO71_AF_L_DD_16)

#define MFP_L_LP_DD_16				(MFP_PIN_GPIO71)
#define MFP_L_LP_DD_16_AF			(MFP_PIN_GPIO71_AF_L_LP_DD_16)

#define MFP_L_DD_17				(MFP_PIN_GPIO72)
#define MFP_L_DD_17_AF				(MFP_PIN_GPIO72_AF_L_DD_17)

#define MFP_L_LP_DD_17				(MFP_PIN_GPIO72)
#define MFP_L_LP_DD_17_AF			(MFP_PIN_GPIO72_AF_L_LP_DD_17)

#define MFP_L_CS				(MFP_PIN_GPIO73)
#define MFP_L_CS_AF				(MFP_PIN_GPIO73_AF_L_CS)

#define MFP_L_CS				(MFP_PIN_GPIO73)
#define MFP_L_LP_CS_AF				(MFP_PIN_GPIO73_AF_L_LP_CS)

#define MFP_U2D_TXREADY				(MFP_PIN_GPIO73)
#define MFP_U2D_TXREADY_AF			(MFP_PIN_GPIO73_AF_UTM_TXREADY)

#define MFP_L_VSYNC				(MFP_PIN_GPIO74)
#define MFP_L_VSYNC_AF				(MFP_PIN_GPIO74_AF_L_VSYNC)

#define MFP_L_VSYNC				(MFP_PIN_GPIO74)
#define MFP_L_LP_VSYNC_AF			(MFP_PIN_GPIO74_AF_L_LP_VSYNC)

#define MFP_RSVD_MSL1_OB_DAT_0			(MFP_PIN_GPIO75)
#define MFP_RSVD_MSL1_OB_DAT_0_AF		(MFP_PIN_GPIO75_AF_MSL1_OB_DAT_0)

#define MFP_RSVD_MSL1_OB_CLK			(MFP_PIN_GPIO76)
#define MFP_RSVD_MSL1_OB_CLK_AF			(MFP_PIN_GPIO76_AF_MSL1_OB_CLK)

#define MFP_RSVD_MSL1_OB_STB			(MFP_PIN_GPIO77)
#define MFP_RSVD_MSL1_OB_STB_AF			(MFP_PIN_GPIO77_AF_MSL1_OB_STB)

#define MFP_RSVD_MSL1_OB_WAIT			(MFP_PIN_GPIO78)
#define MFP_RSVD_MSL1_OB_WAIT_AF		(MFP_PIN_GPIO78_AF_MSL1_OB_WAIT)

#define MFP_RSVD_MSL1_IB_DAT_0			(MFP_PIN_GPIO79)
#define MFP_RSVD_MSL1_IB_DAT_0_AF		(MFP_PIN_GPIO79_AF_MSL1_OB_DAT_0)

#define MFP_RSVD_MSL1_IB_CLK			(MFP_PIN_GPIO80)
#define MFP_RSVD_MSL1_IB_CLK_AF			(MFP_PIN_GPIO80_AF_MSL1_IB_CLK)

#define MFP_RSVD_MSL1_IB_STB			(MFP_PIN_GPIO81)
#define MFP_RSVD_MSL1_IB_STB_AF			(MFP_PIN_GPIO81_AF_MSL1_IB_STB)

#define MFP_RSVD_MSL1_IB_WAIT			(MFP_PIN_GPIO82)
#define MFP_RSVD_MSL1_IB_WAIT_AF		(MFP_PIN_GPIO82_AF_MSL1_IB_WAIT)

#define MFP_RSVD_MSL1_IB_DAT_1			(MFP_PIN_GPIO83)
#define MFP_RSVD_MSL1_IB_DAT_1_AF		(MFP_PIN_GPIO83_AF_MSL1_IB_DAT_1)

#define MFP_U2D_TXVALID				(MFP_PIN_GPIO83)
#define MFP_U2D_TXVALID_AF			(MFP_PIN_GPIO83_AF_U2D_TXVALID)

#define MFP_RSVD_MSL1_IB_DAT_2			(MFP_PIN_GPIO84)
#define MFP_RSVD_MSL1_IB_DAT_2_AF		(MFP_PIN_GPIO84_AF_MSL1_IB_DAT_2)

#define MFP_RSVD_MSL1_IB_DAT_3			(MFP_PIN_GPIO85)
#define MFP_RSVD_MSL1_IB_DAT_3_AF		(MFP_PIN_GPIO85_AF_MSL1_IB_DAT_3)

#define MFP_RSVD_MSL1_OB_DAT_1			(MFP_PIN_GPIO86)
#define MFP_RSVD_MSL1_OB_DAT_1_AF		(MFP_PIN_GPIO86_AF_MSL1_OB_DAT_1)

#define MFP_RSVD_MSL1_OB_DAT_2			(MFP_PIN_GPIO87)
#define MFP_RSVD_MSL1_OB_DAT_2_AF		(MFP_PIN_GPIO87_AF_MSL1_OB_DAT_2)

#define MFP_RSVD_MSL1_OB_DAT_3			(MFP_PIN_GPIO88)
#define MFP_RSVD_MSL1_OB_DAT_3_AF		(MFP_PIN_GPIO88_AF_MSL1_OB_DAT_3)

#define MFP_SSP_AUDIO_SCLK			(MFP_PIN_GPIO89)
#define MFP_SSP_AUDIO_SCLK_AF			(MFP_PIN_GPIO89_AF_SSPSCLK3)

#define MFP_SSP_AUDIO_FRM			(MFP_PIN_GPIO90)
#define MFP_SSP_AUDIO_FRM_AF			(MFP_PIN_GPIO90_AF_SSPSFRM3)

#define MFP_SSP_AUDIO_TXD			(MFP_PIN_GPIO91)
#define MFP_SSP_AUDIO_TXD_AF			(MFP_PIN_GPIO91_AF_SSPTXD3)

#define MFP_SSP_AUDIO_RXD			(MFP_PIN_GPIO92)
#define MFP_SSP_AUDIO_RXD_AF			(MFP_PIN_GPIO92_AF_SSPRXD3)

#define MFP_SSP_4_CLK				(MFP_PIN_GPIO93)
#define MFP_SSP_4_CLK_AF			(MFP_PIN_GPIO93_AF_SSPSCLK4)

#define MFP_SSP_4_FRM				(MFP_PIN_GPIO94)
#define MFP_SSP_4_FRM_AF			(MFP_PIN_GPIO94_AF_SSPSFRM4)

#define MFP_SSP_4_TXD				(MFP_PIN_GPIO95)
#define MFP_SSP_4_TXD_AF			(MFP_PIN_GPIO95_AF_SSPTXD4)

#define MFP_SSP_4_RXD				(MFP_PIN_GPIO96)
#define MFP_SSP_4_RXD_AF			(MFP_PIN_GPIO96_AF_SSPRXD4)

#define MFP_IR_SHDN_N_GPIO			(MFP_PIN_GPIO97)
#define MFP_IR_SHDN_N_GPIO_AF			(MFP_PIN_GPIO97_AF_GPIO_97)

#define MFP_CFNIRQ_GPIO				(MFP_PIN_GPIO98)
#define MFP_CFNIRQ_GPIO_AF			(MFP_PIN_GPIO98_AF_GPIO_98)

#define MFP_U2D_RESET				(MFP_PIN_GPIO98)
#define MFP_U2D_RESET_AF			(MFP_PIN_GPIO98_AF_U2D_RESET)

#define MFP_RSVD_GPIO_99			(MFP_PIN_GPIO99)
#define MFP_RSVD_GPIO_99_AF			(MFP_PIN_GPIO99_AF_GPIO_99)

#define MFP_U2D_XCVR_SELECT			(MFP_PIN_GPIO99)
#define MFP_U2D_XCVR_SELECT_AF			(MFP_PIN_GPIO99_AF_U2D_XCVR_SELECT)

#define MFP_USB_OTG_SR				(MFP_PIN_GPIO100)
#define MFP_USB_OTG_SR_AF			(MFP_PIN_GPIO100_AF_USB_P2_4)

#define MFP_U2D_TERM_SELECT			(MFP_PIN_GPIO100)
#define MFP_U2D_TERM_SELECT_AF			(MFP_PIN_GPIO100_AF_U2D_TERM_SELECT)

#define MFP_OTG_EN				(MFP_PIN_GPIO101)
#define MFP_OTG_EN_AF				(MFP_PIN_GPIO101_AF_USB_P2_8)

#define MFP_U2D_SUSPENDM_X			(MFP_PIN_GPIO101)
#define MFP_U2D_SUSPENDM_X_AF			(MFP_PIN_GPIO101_AF_U2D_SUSPENDM_X)

#define MFP_CIF_HI_PWDN_GPIO			(MFP_PIN_GPIO102)
#define MFP_CIF_HI_PWDN_GPIO_AF			(MFP_PIN_GPIO102_AF_GPIO_102)

#define MFP_U2D_LINESTATE0			(MFP_PIN_GPIO102)
#define MFP_U2D_LINESTATE0_AF			(MFP_PIN_GPIO102_AF_UTM_LINESTATE_0)

#define MFP_CIF_LO_PWDN_GPIO			(MFP_PIN_GPIO103)
#define MFP_CIF_LO_PWDN_GPIO_AF			(MFP_PIN_GPIO103_AF_GPIO_103)

#define MFP_U2D_LINESTATE1			(MFP_PIN_GPIO103)
#define MFP_U2D_LINESTATE1_AF			(MFP_PIN_GPIO103_AF_UTM_LINESTATE_1)

#define MFP_OTG_ID				(MFP_PIN_GPIO104)
#define MFP_OTG_ID_AF				(MFP_PIN_GPIO104_AF_USB_P2_7)

#define MFP_KP_DKIN_0				(MFP_PIN_GPIO105)
#define MFP_KP_DKIN_0_AF			(MFP_PIN_GPIO105_AF_KP_DKIN_0)

#define MFP_KP_DKIN_1				(MFP_PIN_GPIO106)
#define MFP_KP_DKIN_1_AF			(MFP_PIN_GPIO106_AF_KP_DKIN_1)

#define MFP_STD_TXD				(MFP_PIN_GPIO107)
#define MFP_STD_TXD_AF				(MFP_PIN_GPIO107_AF_UART3_TXD)

#define MFP_STD_RXD				(MFP_PIN_GPIO108)
#define MFP_STD_RXD_AF				(MFP_PIN_GPIO108_AF_UART3_RXD)

#define MFP_BT_RTS				(MFP_PIN_GPIO109)
#define MFP_BT_RTS_AF			(MFP_PIN_GPIO109_AF_UART2_RTS)

#define MFP_BT_RXD				(MFP_PIN_GPIO110)
#define MFP_BT_RXD_AF			(MFP_PIN_GPIO110_AF_UART2_RXD)

#define MFP_BT_TXD				(MFP_PIN_GPIO111)
#define MFP_BT_TXD_AF			(MFP_PIN_GPIO111_AF_UART2_TXD)

#define MFP_BT_CTS				(MFP_PIN_GPIO112)
#define MFP_BT_CTS_AF			(MFP_PIN_GPIO112_AF_UART2_CTS)

#define MFP_KP_MKIN_0				(MFP_PIN_GPIO113)
#define MFP_KP_MKIN_0_AF			(MFP_PIN_GPIO113_AF_KP_MKIN_0)

#define MFP_KP_MKIN_1				(MFP_PIN_GPIO114)
#define MFP_KP_MKIN_1_AF			(MFP_PIN_GPIO114_AF_KP_MKIN_1)

#define MFP_KP_MKIN_2				(MFP_PIN_GPIO115)
#define MFP_KP_MKIN_2_AF			(MFP_PIN_GPIO115_AF_KP_MKIN_2)

#define MFP_KP_MKIN_3				(MFP_PIN_GPIO116)
#define MFP_KP_MKIN_3_AF			(MFP_PIN_GPIO116_AF_KP_MKIN_3)

#define MFP_KP_MKIN_4				(MFP_PIN_GPIO117)
#define MFP_KP_MKIN_4_AF			(MFP_PIN_GPIO117_AF_KP_MKIN_4)

#define MFP_KP_MKIN_5				(MFP_PIN_GPIO118)
#define MFP_KP_MKIN_5_AF			(MFP_PIN_GPIO118_AF_KP_MKIN_5)

#define MFP_KP_MKIN_6				(MFP_PIN_GPIO119)
#define MFP_KP_MKIN_6_AF			(MFP_PIN_GPIO119_AF_KP_MKIN_6)

#define MFP_KP_MKIN_7				(MFP_PIN_GPIO120)
#define MFP_KP_MKIN_7_AF			(MFP_PIN_GPIO120_AF_KP_MKIN_7)
...
#define MFP_KP_MKOUT_5				(MFP_PIN_GPIO126)
#define MFP_KP_MKOUT_5_AF			(MFP_PIN_GPIO126_AF_KP_MKOUT_5)

#define MFP_KP_MKOUT_6				(MFP_PIN_GPIO127)
#define MFP_KP_MKOUT_6_AF			(MFP_PIN_GPIO127_AF_KP_MKOUT_6)

#define MFP_ONE_WIRE				(MFP_PIN_GPIO0_2)
#define MFP_ONE_WIRE_AF				(MFP_PIN_GPIO0_2_AF_ONE_WIRE)

#define MFP_RSVD_GPIO_1				(MFP_PIN_GPIO1_2)
#define MFP_RSVD_GPIO_1_AF			(MFP_PIN_GPIO1_2_AF_GPIO_1)

#define MFP_USBHPEN				(MFP_PIN_GPIO2_2)
#define MFP_USBHPEN_AF				(MFP_PIN_GPIO2_2_AF_USBHPEN)

#define MFP_USBHPWR				(MFP_PIN_GPIO3_2)
#define MFP_USBHPWR_AF				(MFP_PIN_GPIO3_2_AF_USBHPWR)

#define MFP_RSVD_GPIO_4				(MFP_PIN_GPIO4_2)
#define MFP_RSVD_GPIO_4_AF			(MFP_PIN_GPIO4_2_AF_GPIO_4)

#define MFP_KP_MKOUT_7				(MFP_PIN_GPIO5_2)
#define MFP_KP_MKOUT_7_AF			(MFP_PIN_GPIO5_2_AF_KP_MKOUT_7)

#define MFP_L_DD_0				(MFP_PIN_GPIO6_2)
#define MFP_L_DD_0_AF				(MFP_PIN_GPIO6_2_AF_L_DD_0)

#define MFP_L_LP_DD_0				(MFP_PIN_GPIO6_2)
#define MFP_L_LP_DD_0_AF			(MFP_PIN_GPIO6_2_AF_L_LP_DD_0)

#define MFP_L_DD_1				(MFP_PIN_GPIO7_2)
#define MFP_L_DD_1_AF				(MFP_PIN_GPIO7_2_AF_L_DD_1)

#define MFP_L_LP_DD_1				(MFP_PIN_GPIO7_2)
#define MFP_L_LP_DD_1_AF			(MFP_PIN_GPIO7_2_AF_L_LP_DD_1)

#define MFP_L_DD_2				(MFP_PIN_GPIO8_2)
#define MFP_L_DD_2_AF				(MFP_PIN_GPIO8_2_AF_L_DD_2)

#define MFP_L_LP_DD_2				(MFP_PIN_GPIO8_2)
#define MFP_L_LP_DD_2_AF			(MFP_PIN_GPIO8_2_AF_L_LP_DD_2)

#define MFP_L_DD_3				(MFP_PIN_GPIO9_2)
#define MFP_L_DD_3_AF				(MFP_PIN_GPIO9_2_AF_L_DD_3)

#define MFP_L_LP_DD_3				(MFP_PIN_GPIO9_2)
#define MFP_L_LP_DD_3_AF			(MFP_PIN_GPIO9_2_AF_L_LP_DD_3)

#define MFP_L_DD_4				(MFP_PIN_GPIO10_2)
#define MFP_L_DD_4_AF				(MFP_PIN_GPIO10_2_AF_L_DD_4)

#define MFP_L_LP_DD_4				(MFP_PIN_GPIO10_2)
#define MFP_L_LP_DD_4_AF			(MFP_PIN_GPIO10_2_AF_L_LP_DD_4)

#define MFP_L_DD_5				(MFP_PIN_GPIO11_2)
#define MFP_L_DD_5_AF				(MFP_PIN_GPIO11_2_AF_L_DD_5)

#define MFP_L_LP_DD_5				(MFP_PIN_GPIO11_2)
#define MFP_L_LP_DD_5_AF			(MFP_PIN_GPIO11_2_AF_L_LP_DD_5)

#define MFP_L_DD_6				(MFP_PIN_GPIO12_2)
#define MFP_L_DD_6_AF				(MFP_PIN_GPIO12_2_AF_L_DD_6)

#define MFP_L_LP_DD_6				(MFP_PIN_GPIO12_2)
#define MFP_L_LP_DD_6_AF			(MFP_PIN_GPIO12_2_AF_L_LP_DD_6)

#define MFP_L_DD_7				(MFP_PIN_GPIO13_2)
#define MFP_L_DD_7_AF				(MFP_PIN_GPIO13_2_AF_L_DD_7)

#define MFP_L_LP_DD_7				(MFP_PIN_GPIO13_2)
#define MFP_L_LP_DD_7_AF			(MFP_PIN_GPIO13_2_AF_L_LP_DD_7)

#define MFP_L_FCLK				(MFP_PIN_GPIO14_2)
#define MFP_L_FCLK_AF				(MFP_PIN_GPIO14_2_AF_L_FCLK_RD)

#define MFP_L_LP_FCLK				(MFP_PIN_GPIO14_2)
#define MFP_L_LP_FCLK_AF			(MFP_PIN_GPIO14_2_AF_L_LP_FCLK)

#define MFP_L_LCLK				(MFP_PIN_GPIO15_2)
#define MFP_L_LCLK_AF				(MFP_PIN_GPIO15_2_AF_L_LCLK_A0)

#define MFP_L_LP_LCLK				(MFP_PIN_GPIO15_2)
#define MFP_L_LP_LCLK_AF			(MFP_PIN_GPIO15_2_AF_L_LP_LCLK)

#define MFP_L_PCLK				(MFP_PIN_GPIO16_2)
#define MFP_L_PCLK_AF				(MFP_PIN_GPIO16_2_AF_L_PCLK_WR)

#define MFP_L_LP_PCLK				(MFP_PIN_GPIO16_2)
#define MFP_L_LP_PCLK_AF			(MFP_PIN_GPIO16_2_AF_L_LP_PCLK)

#define MFP_L_BIAS				(MFP_PIN_GPIO17_2)
#define MFP_L_BIAS_AF				(MFP_PIN_GPIO17_2_AF_L_BIAS)

#define MFP_L_LP_BIAS				(MFP_PIN_GPIO17_2)
#define MFP_L_LP_BIAS_AF			(MFP_PIN_GPIO17_2_AF_L_LP_BIAS)
...
#define MFP_DF_INT_RnB_AF			(MFP_PIN_DF_INT_RnB_AF_DF_INT_RnB)
...
#define MFP_DF_nADV1				(MFP_PIN_DF_nADV1_ALE)
#define MFP_DF_nADV1_AF				(MFP_PIN_DF_nADV1_ALE_AF_ND_ALE)

#define MFP_DF_nADV2				(MFP_PIN_DF_nADV2_ALE)
#define MFP_DF_nADV2_AF				(MFP_PIN_DF_nADV2_ALE_AF_ND_ALE)

#define MFP_DF_NCS0				(MFP_PIN_DF_nCS0)
#define MFP_DF_NCS0_AF				(MFP_PIN_DF_nADV2_ALE_AF_ND_ALE)

#define MFP_DF_NCS1				(MFP_PIN_DF_nCS1)
#define MFP_DF_NCS1_AF				(MFP_PIN_DF_nCS1_AF_ND_NCS1)

#define MFP_DF_nRE				(MFP_PIN_DF_nRE_nOE)
#define MFP_DF_nRE_AF				(MFP_PIN_DF_nRE_nOE_AF_ND_nRE)

#define MFP_DF_nWE				(MFP_PIN_DF_nWE)
#define MFP_DF_nWE_AF				(MFP_PIN_DF_nWE_AF_ND_nWE)
...
#define MFP_DEBUG_ETH_nBE0_AF			(MFP_PIN_nBE0_AF_nBE0)

#define MFP_DEBUG_ETH_nBE1			(MFP_PIN_nBE1)
#define MFP_DEBUG_ETH_nBE1_AF			(MFP_PIN_nBE1_AF_nBE1)

#define MFP_ND_CLE				(MFP_PIN_ND_CLE)
#define MFP_ND_CLE_AF				(MFP_PIN_ND_CLE_AF_ND_CLE)

#define MFP_nLLA				(MFP_PIN_nLLA)
#define MFP_nLLA_AF				(MFP_PIN_nLLA_AF_nLLA)

#define MFP_nLUA				(MFP_PIN_nLUA)
#define MFP_nLUA_AF				(MFP_PIN_nLUA_AF_nLUA)

#define MFP_RSVD_nXCVREN			(MFP_PIN_nXCVREN)
#define MFP_RSVD_nXCVREN_AF			(MFP_PIN_nXCVREN_AF_nXCVREN)
...
//#define MFP_CAMERA_STROBE_EN_GPIO		(MFP_PIN_GPIO99)
//#define MFP_CAMERA_STROBE_EN_GPIO_AF		(MFP_PIN_GPIO99_AF_GPIO_99)
...
#define MFP_U2D_XCVR_SELECT_AF			(MFP_PIN_GPIO101_AF_U2D_XCVR_SELECT_PF)

#define MFP_U2D_TERM_SELECT			(MFP_PIN_GPIO102)
#define MFP_U2D_TERM_SELECT_AF			(MFP_PIN_GPIO102_AF_U2D_TERM_SELECT_PF)
...
void pxa3xx_enable_pccard_pins(void);
void pxa3xx_enable_ide_pins(void);
#endif
