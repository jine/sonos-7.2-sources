...
/* indexes for page_list */
#define SRAMSTART	(0)
#define SRAMEND		(IMM_SRAM_PAGES)

#define SRAM_PHYS_ADDRESS(i)	(IMM_SRAM_START + ((i)*PAGE_SIZE))
...
#define SRAM_ARRAY_STARTPAGE(x) (((x)-IMM_SRAM_FIRST_BANK)*(IMM_SRAM_PAGES/IMM_SRAM_BANK_COUNT))
...
extern struct imm_page_t page_list[IMM_SRAM_PAGES];
