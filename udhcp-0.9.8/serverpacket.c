...
static void add_bootp_options(struct dhcpMessage *packet)
{
	...
	if (server_config.sname)
		strncpy((char*)packet->sname, (const char*)server_config.sname, sizeof(packet->sname) - 1);
	if (server_config.boot_file)
		strncpy((char*)packet->file, (const char*)server_config.boot_file, sizeof(packet->file) - 1);
}
...
int sendOffer(struct dhcpMessage *oldpacket)
{
	...
	if ((lease_time = get_option(oldpacket, DHCP_LEASE_TIME)) && lease_time[OPT_LEN - 2] == 4) {
